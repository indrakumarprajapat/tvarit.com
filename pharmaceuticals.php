                ...
                <div class="col-md">
                    <div class="col-md">
                        <div class="px-4 box-content-left">
                            ...
                            <div class="imgW-more">
                                <p class="text-p">The pharmaceutical industry has always been upbeat about predictive
                                    analytics. When it comes to how, they’ve set a straightforward model. They use
                                    predictive analytics to create a data set which tells whether the patients are going
                                    to respond affirmative or negative to the treatment. Also, they can actually prevent
                                    things happening by using sensor data to spot the biomarker and predict the trends
                                    and symptoms. Pharmaceutical companies will be able to gauge how well they’re doing
                                    in comparison to other companies, competitively & scientifically. And adding it all
                                    up, there is always scope to shine up the R&D. This explains why pharma companies
                                    have always been high pulsed towards APA.</p>
                            </div>
                        </div>
                    </div>
                </div>
