                                    ...
                                    <div class="generic_content clearfix">
                                        ...
                                        <div class="generic_feature_list">
                                            <ul>
                                                ...
                                                <li>Default Pipeline Integration</li>
                                                <li>Default Handlers Integration</li>
                                                <li><span>8*5</span> Email and Chat Support</li>
                                                <li class="disabled">Schedulers</li>
                                                <li class="disabled">Custom Pipeline Integration</li>
                                                <li class="disabled">Custom Handler Integration</li>
                                            </ul>
                                        </div>
                                        <div class="account_list">
                                            <h5>Included with your account:</h5>
                                            <h6><span>*</span>Build minutes: 100hrs/mo</h6>
                                            <h6><span>*</span>File storage: 1GB</h6>
                                            <h6><span>*</span>Dataset Size: 15MB</h6>
                                        </div>
                                        <!--//FEATURE LIST END-->
                                    ...
                                    <div class="generic_content active clearfix">
                                        ...
                                        <div class="generic_feature_list">
                                            <ul>
                                                ...
                                                <li>Default Pipeline Integration</li>
                                                <li>Default Handlers Integration</li>
                                                <li><span>10*5</span> Email and Chat Support</li>
                                                <li>Schedulers</li>
                                        ...
                                        <div class="account_list">
                                            <h5>Included with your account:</h5>
                                            <h6><span>*</span>Build minutes: 800hrs/mo</h6>
                                            <h6><span>*</span>File storage: 50GB</h6>
                                            <h6><span>*</span>Dataset Size: 100MB</h6>
                                        </div>
                                        <!--//FEATURE LIST END-->
                                    ...
                                    <div class="generic_content clearfix">
                                        ...
                                        <div class="generic_feature_list">
                                            <ul>
                                                ...
                                                <li>Schedulers</li>
                                                <li>Custom Pipeline Integration</li>
                                                <li>Custom Handler Integration</li>
                                            </ul>
                                        </div>
                                        <div class="account_list">
                                            <h5>Included with your account:</h5>
