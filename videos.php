...
<a style="padding-right:5px;" class="nav-link lang-link" href="https://de.tvarit.com/"><b>DE</b></a>
    ...
    <!------------------------ header start ------------------------->
    <header class="headerBg videosBg">
      <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-md-6">
            <div class="typography">
              ...
              <div class="more">
                <p class="text-p">
                An investment in knowledge pays the best interest. If you're looking for a visual outlook of the intriguing world of the Fourth Industrial Revolution, we have a lot of insightful videos for you. Scroll below to find your topics of interest.
              </p>
              </div>
    ...
    <div class="section-padding-both" id="downClick">
      <div class="container">
          <div class="videoPageBlog">
              <div class="row scrollable-blogs" >
                <div class="col-md-3">
                  <div class="blogBox">
                    <div class="blogPic">
                      <a data-fancybox href="https://www.youtube.com/embed/VD4G8FvHMv4?rel=0" class="playVideo">
                ...
                <div class="col-md-3">
                  <div class="blogBox">
                    <div class="blogPic">
                      <a data-fancybox href="https://www.youtube.com/embed/YnX6ji9OdYY?rel=0" class="playVideo">
                        <i class="far fa-play-circle"></i>
                      </a>
                ...
                <div class="col-md-3">
                  <div class="blogBox">
                    <div class="blogPic">
                      <a data-fancybox href="https://www.youtube.com/embed/CmiMjQvoQr8?rel=0" class="playVideo">
                        <i class="far fa-play-circle"></i>
                      </a>
                ...
                <div class="col-md-3">
                  <div class="blogBox">
                    <div class="blogPic">
                      <a data-fancybox href="https://www.youtube.com/embed/lu8yIPb5V-A?rel=0" class="playVideo">
                        <i class="far fa-play-circle"></i>
                      </a>
                ...
                <div class="col-md-3">
                  <div class="blogBox">
                    <div class="blogPic">
                      <a data-fancybox href="https://www.youtube.com/embed/iC945FKUH8I?rel=0" class="playVideo">
                        <i class="far fa-play-circle"></i>
                      </a>
                ...
                <div class="col-md-3">
                  <div class="blogBox">
                    <div class="blogPic">
                      <a data-fancybox href="https://www.youtube.com/embed/WWfubROExsw?rel=0" class="playVideo">
                        <i class="far fa-play-circle"></i>
                      </a>
