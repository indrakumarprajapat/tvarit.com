    ...
    <div class="section-padding" id="downClick">
        <div class="container">
            <div class="text-left text-md-center">
                ...
                <p class="bold uppr w-75 w-md-50 m-md-auto">We hold a plethora of seminars both for those interested in
                    technical and non-technical fields.A few of them are</p>
            </div>
            <br>
            <div class="row">
                <div class="col-md">
        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-md-4 flex-center">
                    <div class="red text-big40">Also, we hold multiple workshops.<br>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="leftSideFilter checkbox-filter white-box-shadow cstmInput">
                        <div class="red text-big40" style="font-size:25px;">Talk-cum-Workshop<br>
                            <div class="short-line bg-grey"></div>
                        </div>
                        <p>
                            Frankfurt Indian Scholars Association(FISA) organised a Talk-cum-Workshop in coordination
                            with Consulate General of India (CGI) in Frankfurt.
                        </p>
                    </div>
                </div>
