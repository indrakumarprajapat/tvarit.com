            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="typography">
                        ...
                        <br>
                        <p class="text-p">
                            Predictive maintenance, capital investment decisions, customer insights. We know you like to
                            stand strong.
                        </p>
                        <br>
                ...
                <div class="col-md">
                    <div class="col-md">
                        <div class="px-4 box-content-left">
                            ...
                            <div class="imgW-more">
                                <p class="text-p">The steel industry has always aimed to stand tough and strong. When it
                                    came to the use of predictive analytics in doing so, they've never been passive
                                    towards it. Predictive analytics offers predictive maintenance, capital investment
                                    decisions, customer insights and a lot more. With the help of it, a precise amount
                                    of components can be easily added in the raw material during production to increase
                                    quality and cut the losses. Also, predictive maintenance can notify the operations
                                    manager beforehand about when the machinery will need repair and under what
                                    circumstances to minimize the chances of damage, decrease downtime and hence
                                    increase efficiency, productivity, and profit. No wonder why the steel industry is
                                    keen on the use of analytics and manufacturers are calling it a sharp deal.</p>
                            </div>
                        </div>
                    </div>
                </div>
