            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="typography">
                        ...
                        <div class="more">
                            <p class="text-p">
                                Sharing knowledge can seem like a burden to some but on the contrary, it is a reflection
                                of teamwork and Team. With the same belief and fire, we are always eager to assist you
                                in whatever manner possible. Tvarit AI with its team is looking forward to answering all
                                your queries.
                            </p>
                        </div>
                        <br>
    ...
    <div class="section-padding-both" id="downClick">
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-md">
                    <div class="AmimgBox">
                        <img src="img/cns-1.jpg" class="img-fluid">
                    </div>
                </div>
                <div class="col-md">
                    <div class="px-4 box-content-left">
                        <div class="title">
                            <div class="text-big60 fw-900 red">Consulting</div>
                        </div>
                        <div class="short-line bg-red"></div>
                        <div class="imgW-more">
                            <p class="text-p">Tvarit AI is always eager to help. If you need any guidance in
                                understanding the latest technological requirements and infrastructure along with its
                                impact on your organization, we have multiple resources to assist you. Tvarit AI has a
                                vast experience in developing a variety of large and complex projects using
                                heterogeneous technologies and software development methodologies. Our customized expert
                                consulting services are specifically designed to provide you with all necessary
                                resources be it Expert manpower, technological expertise, Quality services or R&D
                                services to make you meet all the ends without any hassle. We offer a broad range of
                                services to fill any workspace gaps and accomplish a successful software project.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md">
                    <div class="white-box-shadow left-border">
                        <p class="text-p">
                            We strongly believe that to make a project successful, it is extremely crucial to have a
                            competent, expert & trustable partner. Therefore, we are ready to follow your development
                            methodologies, protocols, work-flows, and tools whenever required. For further queries,
                            please contact us stating your requirements, we assure to provide our expert's views of your
                            requirements as a complimentary service.
                        </p>
                    </div>
                </div>
            </div>
