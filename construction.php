            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="typography">
                        ...
                        <br>
                        <p class="text-p">
                            One miscalculation hurts? Managing finance, maintenance, predicting workload, cutting costs,
                            increasing efficiency, we’re here.
                        </p>
                        <br>
                ...
                <div class="col-md">
                    <div class="col-md">
                        <div class="px-4 box-content-left">
                            ...
                            <div class="imgW-more">
                                <p class="text-p">In construction, even the slightest slip-up or miscalculation can lead
                                    to millions of dollars lost or not finishing a project on time. Using predictive
                                    analysis, jobs can be completed more efficiently and on time. Also, with no
                                    haphazard trends and problems that may occur can be identified with it. It’s so
                                    vital to keep upright records of purchase orders and that too in precise quantity.
                                    Analytics can also help with your supply chain and where to place your materials at
                                    any point in time. Predictive analytics can assist your yearly budget, accurately
                                    determine the weather and climate. As the construction industry can be seasonal,
                                    this will help mark the busy seasons as well as the grim ones. Managing finance,
                                    managing maintenance, predicting workload, cutting costs, managing materials,
                                    increasing efficiency, sounds so amazing to ignore, hence steeping the inclination
                                    towards predictive analytics.</p>
                            </div>
                        </div>
                    </div>
                </div>
