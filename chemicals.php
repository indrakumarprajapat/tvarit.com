            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="typography">
                        ...
                        <br>
                        <p class="text-p">
                            Quality prediction, maintenance, and an understanding of what happens inside the plant, we
                            keep the composition intact.
                        </p>
                        <br>
                ...
                <div class="col-md">
                    <div class="col-md">
                        <div class="px-4 box-content-left">
                            ...
                            <div class="imgW-more">
                                <p class="text-p">Chemical manufacturers have realized that predictive analysis can be
                                    the next boom in this industry. As tempting as it sounds, it raises the level of
                                    understanding of what happens inside the plant, smoothen manufacturing operations
                                    and have predictive maintenance at their disposal. All the chronicles of the
                                    production units & their machinery can be filtered in a flick to analyze when it
                                    will break, the period of service and also the fundamental issues of failure to fix
                                    them to prevent the actual avalanche. As the data speaks, predictive maintenance
                                    condenses downtime by 30-50% and surges the machine life by 20-40%. This will cut
                                    the cost, increase profit margin, efficiency and might as well give the company an
                                    edge. Summing up, APA can add a cherry to the cake in chemical industries.</p>
                            </div>
                        </div>
                    </div>
                </div>
