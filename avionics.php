            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="typography">
                        ...
                        <br>
                        <p class="text-p">
                            Target marketing, risk management, load forecasting, flight safety, predictive maintenance.
                            We want you to Keep flying high.
                        </p>
                        <br>
                ...
                <div class="col-md">
                    <div class="col-md">
                        <div class="px-4 box-content-left">
                            ...
                            <div class="imgW-more">
                                <p class="text-p">The aviation industry has never been a passive player. With the glamor
                                    of predictive analytics, avionics has taken great benefits from it. Be it target
                                    marketing, risk management, load forecasting, flight safety, everything has been
                                    covered under it. By predictive analytics of the collected data set, airlines can
                                    offer its travelers the best rates and experiences possible and allow them to offer
                                    personalized offers to customers based on their behavior patterns. The development
                                    of an effective and holistic forecasting model to regularly assess the impact of
                                    options and alternatives such as increasing aircraft seats available, adjusting
                                    fares, introducing new routes etc. can be done for comparison against budgets and
                                    prior year performance. Also, predictive maintenance and security can be employed to
                                    be alerted prior to the damage. </p>
                            </div>
                        </div>
                    </div>
                </div>
