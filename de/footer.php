        ...
        <div class="row justify-content-center">
          <div class="col-md-8">
            <div class="form-group">
             <div class="addon">
                <input type="text" class="form-control" id="emailDemo" placeholder="E-Mail" >
                <input   type="button" value="senden" id="btnDemo"  class="btn btn-round btn-red-grd">
             </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-4 section-padding">
            <div class="ft-about">
              ...
              <div class="ftaboutmore">
                ...
                Schlagwort. Ein Zusammentreffen von Trends und Technologien verspricht, die Art und Weise, wie Dinge 
                ...
                <p class="text-p">
                Aus diesem Grund arbeiten wir bei Tvarit AI unermüdlich daran, Ihr Geschäft und Ihr Leben zu 
                vereinfachen und zu verbessern. Wenn wir bereits Ihre Neugier geweckt haben, schauen Sie sich doch 
                gerne weiter um.  
                Willkommen Tvarit AI, Willkommen unbegrenzte Möglichkeiten! 
                </p>
              </div>
            </div>
