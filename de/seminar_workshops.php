            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="typography">
                        ...
                        <div class="more">
                            <p class="text-p">
                                Der Austausch von Wissen kann für manche wie eine Bürde erscheinen, ist aber im
                                Gegenteil ein Ausdruck
                                von Teamarbeit. Mit dem gleichen Glauben und Feuer sind wir immer bestrebt, Ihnen auf
                                jede erdenkliche
    ...
    <div class="section-padding" id="downClick">
        <div class="container">
            <div class="text-left text-md-center">
                ...
                <p class="bold uppr w-75 w-md-50 m-md-auto">WIR VERANSTALTEN EINE VIELZAHL VON SEMINAREN SOWOHL FÜR
            ...
            <div class="row">
                <div class="col-md">
                    ...
                    <ul class="ul-list-bullet">
                        ...
                        <li>KI vs. Globalisierung: Wie würde die KI den Menschen nicht ersetzen, sondern ihm helfen?
                        </li>
        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-md-4 flex-center">
                    <div class="red text-big40">AUßERDEM FÜHREN WIR MEHRERE WORKSHOPS DURCH.<br>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="leftSideFilter checkbox-filter white-box-shadow cstmInput">
                        <div class="red text-big40" style="font-size:25px;">GESPRÄCHS-WORKSHOP<br>
                            <div class="short-line bg-grey"></div>
                        </div>
                        <p>
                            Die Frankfurt Indian Scholars Association (FISA) organisierte in Abstimmung mit dem
                            Generalkonsulat
