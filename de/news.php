...
<body>
    ...
    <header class="headerBg whitepaperBg">
        <div class="container">
            <a href="#Event" class="hdrscrollArrow"><i class="icon ion-ios-arrow-dropdown"></i></a>
          ...
          <div class="item">
            <a href="javascript://" class="newsBox">
              ...
              <div class="news-content">
                ...
                <h4 class="title">Tvarit has been invited to showcase its ‘AI for Manufacturing’ software at Germany’s biggest electronics association annual conference</h4>
                <div class="post-text">
           ...
           <div class="item">
            <a href="javascript://" class="newsBox">
              <div class="news-pic">
                <img src="img/berlinEve.png" style="height: 137px;" class="img-fluid">
              </div>
              <div class="news-content">
                <div class="text-sub">ZVEI-Jahreskongress 2019</div>
                <h4 class="title">Menschlich. Künstlich. Intelligent.Technologie nutzen, Leben verbessern.</h4>
                <div class="post-text">
                  News Post <span class="date">22. und 23. Mai 2019, Maritim Hotel, Berlin</span>
                </div>
              </div>
            </a>
          </div> -->
