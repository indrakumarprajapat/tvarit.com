...
gtag('config', 'UA-143837547-1');
        ...
        <title>On the road- Big Data and the Automobile industry</title>
   ...
   <li class="nav-item">
    ...
    <div class="section-padding-both-2x" id="downClick">
      <div class="container">
        ...
        On the road- Big Data and the Automobile industry
        </div>
        ...
        <h4>Here is where big data has set foot:</h4>

        <br>

        <h5 class="red">A. The connected car</h5>
        <p class="text-p">
        ...
        <h5 class="red">B. Design and Manufacturing</h5>
        <p class="text-p">
        ...
        <h5 class="red">C. Predictive maintenance</h5>
        <p class="text-p">
        ...
        <h5 class="red">D. Automobile financing</h5>
        <p class="text-p">
        ...
        <p class="text-p">
         Shortly, next-generation automak­ers will be evaluated based on the complete­ness of their solution and more five dimen­sions -Electric, Autonomous, Connected, Mobility Services and Information and not only by the physical, safety and performance attributes of their vehicles. This is why automakers and Tvarit AI are all fueled up to race with the assistance of big data and make the automobile industry nothing less than a sci-fi movie.
        </p>
