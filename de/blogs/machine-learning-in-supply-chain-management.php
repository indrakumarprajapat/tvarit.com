...
gtag('config', 'UA-143837547-1');
        ...
        <title>Machine Learning reforming the Supply Chain Management</title>
   ...
   <li class="nav-item">
    ...
    <div class="section-padding-both-2x" id="downClick">
      <div class="container">
        ...
        <h4>So, how do these two different spheres interject? Let's have a look</h4>

        <br>

        <h5 class="red">1. Forecasting accurate demand</h5>
        <p class="text-p">
        ...
        <h5 class="red">2. Improving the supply chain</h5>
        <p class="text-p">
        ...
        <h5 class="red">3. Enhanced Customer Experience</h5>
        <p class="text-p">
        ...
        <h5 class="red">4. Improving Sales</h5>
        <p class="text-p">
        ...
        <h5 class="red">5. Forecasting the Overall Equipment Effectiveness</h5>
        <p class="text-p">
