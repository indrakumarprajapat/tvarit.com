...
gtag('config', 'UA-143837547-1');
        ...
        <title>THE WINDS OF CHANGE- AI TRANSFORMING THE ENERGY INDUSTRY</title>
   ...
   <li class="nav-item">
    ...
    <div class="section-padding-both-2x" id="downClick">
      <div class="container">
        ...
        THE WINDS OF CHANGE- AI TRANSFORMING THE ENERGY INDUSTRY
        </div>
        ...
        <h4>Thankfully, we have Artificial Intelligence at our disposal</h4>

        <br>

        <h5 class="red">1. Forecasting the weather</h5>
        <p class="text-p">
        ...
        <h5 class="red">2. Smart maintenance</h5>
        <p class="text-p">
        ...
        <h5 class="red">3. Customized Wind Turbines</h5>
        <p class="text-p">
