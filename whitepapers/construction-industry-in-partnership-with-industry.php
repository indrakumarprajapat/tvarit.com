    ...
    <div class="section-padding-both-2x" id="downClick">
        <div class="container">
            ...
            <p class="text-medium fw-700">
                With the world trying so hard to walk hand in hand with Artificial Intelligence, it is a harsh
                realization that engineering and construction are behind the curve in achieving artificial intelligence
                solutions. The problem does not lie in the unavailability of resources though. Design and BIM data from
                the planning stages of a project, job site data collected by wearables, accounting and job progress data
                from the office, project management data from mobile devices and sensors on equipment/materials- are a
                few excellent sources to collect Big Data. The problem lies in the unavailability of proper means to
                parse and analyze the data in significant and useful ways.
            </p>


            <p class="text-p">
                According to analysts, artificial intelligence (AI) in the construction market will register a CAGR of
                over 28% by 2023 with an approximation to earn around USD 2,011.4 million during the forecast period
                (2017-2023). The global market is expected to record 35% CAGR owing to the surging interest for safety
                considerations.
            </p>

            <p class="text-p">
                The major areas to be worked upon are- safety, value, and productivity. With the collected Big Data,
                useful insights can be drawn to acknowledge the same. Revamping productivity, search results can be
                collected quickly and sent to the site supervisor who in other cases requires a good deal of time.
            </p>

            <p class="text-p">
                Speaking of safety, operator assistance programs can be built which will use AI algorithms to detect and
                interpret specific objects using computer vision methods. In case of an anomaly, the operator will be
                alerted by the system reducing accident risks. Also, to further concrete the safety measures, some
                repetitive and dangerous labor-intensive tasks can be simplified and performed with AI assistance.
            </p>

            <p class="text-p">
                Adding value, AI algorithms can survey a proposed construction site to collect sufficient information to
                create 3D maps, blueprints, and construction plans on a more precise scale and in a lesser amount of
                time. The historical data on past projects can be analyzed to provide smart insights. This can help AI
                systems advise and present a case for how the particular project should proceed in a more systematic,
                productive and efficient manner.
            </p>

            <p class="text-p">
                All of this is at the expense of Predictive Analytics by the usage of Big Data. It is highly anticipated
                that the fourth Industrial Revolution will further concrete the construction industry.
            </p>
