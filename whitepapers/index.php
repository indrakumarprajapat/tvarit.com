            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="typography">
                        ...
                        <br>
                        <p class="text-p">
                            For a detailed and technical analysis and reading, refer to our white papers, customized
                            ...
                            <ul class="accordion">
                                <li>
                                    ...
                                    <div class="inner">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="Construction"
                                                    value=".Construction">
                                                <label class="custom-control-label"
                                                    for="Construction">Construction</label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="inner">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="QualityPrediction">Quality
                                                    Prediction</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input"
                                                    id="PredictiveMaintenance" value=".PredictiveMaintenance">
                                                <label class="custom-control-label"
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input"
                                                    id="AssetAndInventoryManagement"
                                                    value=".AssetAndInventoryManagement">
                                                <label class="custom-control-label"
                                                    for="AssetAndInventoryManagement">Asset & Inventory
                                                    Management</label>
                                            </div>
                                        </div>
