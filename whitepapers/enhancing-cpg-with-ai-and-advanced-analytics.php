...
<a style="padding-right:5px;" class="nav-link lang-link" href="https://de.tvarit.com/"><b>DE</b></a>
    ...
    <div class="section-padding-both-2x" id="downClick">
      <div class="container">
        ...
        <h5 class="mb-3">Before scaling up AI and Advanced Analytics in CPG, the following steps can be considered for quicker implementation:</h5>
        <ul class="ul-list-bullet">
          <li>Filter the options- for better focus and lesser scattering; the CPGs should come up with countable applications. </li>
          <li>Identify the sponsorship- before actually stepping in; it's crucial that the CPG identify ventures to pivot their application. Brands should also work to guarantee that there is notable interest among the local members who'll assist the application launch and marketing.</li>
          <li>Address market specific needs- the earlier these are addressed, and the quicker the issues are noted, the better can new services be implemented by the brands.</li>
