...
<body>
    ...
    <div class="section-padding-both-2x">
        <div class="container">
            ...
            <p class="text-p">
                Hiermit distanzieren sich die im Impressum Genannten ausdrücklich von allen Inhalten verlinkter Seiten
                oder Grafiken und machen sich diese keinesfalls zu eigen. Sämtliche Verstoße gegen geltendes Recht,
                Sitte oder Moral, welche bekannt werden, haben die sofortige Löschung von Links, Beiträgen, Einträgen,
                Grafiken oder Ähnlichem zur Folge.
            </p>
            <p class="text-p">
            ...
            <p class="text-p">
                Dieses Impressum ist auch für die nachfolgenden Social-Media-Profile gültig:<br>
            </p>
            <div class="ft-social">
                <div class="social-icon">
                    ...
                    <a href="https://www.youtube.com/playlist?list=PLqOwcayv0lYbbyKLjn6-A0w3Es4CKZpGr" target="blank"><i
